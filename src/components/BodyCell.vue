    ...
    <template v-else-if="columnProp('rowReorder')">
      <i
        :class="[
          ...
          columnProp('rowReorderIcon') || 'pi pi-bars',
        ]"
      ></i>
    </template>
...
import RowRadioButton from "../../node_modules/primevue/datatable/RowRadioButton.vue";
  ...
  methods: {
    ...
    getVirtualScrollerProp(option) {
      return this.virtualScrollerContentProps
        ? this.virtualScrollerContentProps[option]
        : null;
    },
  },
  computed: {
