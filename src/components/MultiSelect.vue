      ...
      <div :class="labelClass">
        <slot name="value" :value="modelValue" :placeholder="placeholder">
          ...
          <template v-else-if="display === 'chip'">
            <div
              v-for="item of chipSelectedItems"
            ...
            >
              ...
              <span
                v-if="!disabled"
                :class="['p-multiselect-token-icon', removeTokenIcon]"
                @click.stop="removeOption($event, item)"
              ></span>
            </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span
                  :class="['p-checkbox-icon', { [checkboxIcon]: allSelected }]"
                ></span>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  <draggable
                    :list="options"
                    @end="updateModel(event, options2)"
                  >
                    ...
                    >
                      ...
                      <li
                        ...
                        :class="[
                          'p-multiselect-item',
                          {
                            'p-highlight': isSelected(element),
                            'p-focus':
                              focusedOptionIndex ===
                              getOptionIndex(i, getItemOptions),
                            'p-disabled': isOptionDisabled(element),
                          },
                        ]"
                        role="option"
                        :aria-label="getOptionLabel(element)"
                        :aria-selected="isSelected(element)"
                        :aria-disabled="isOptionDisabled(element)"
                        ...
                        <div class="p-checkbox p-component">
                          ...
                          >
                            <span
                              :class="[
                                'p-checkbox-icon',
                                { [checkboxIcon]: isSelected(element) },
                              ]"
                            ></span>
                          </div>
                        </div>
  ...
  methods: {
    ...
    removeOption(event, optionValue) {
      let value = this.modelValue.filter(
        (val) => !ObjectUtils.equals(val, optionValue, this.equalityKey)
      );
    ...
    isSelected(option) {
      ...
      // this.options2 = optionValue;
      // console.log("oooooooooooooooooooooooo");
      // console.log(this.options);

      return (this.modelValue || []).some((value) =>
        ObjectUtils.equals(value, optionValue, this.equalityKey)
      );
    },
    ...
    findLastSelectedOptionIndex() {
      return this.hasSelectedOption
        ? ObjectUtils.findLastIndex(this.visibleOptions, (option) =>
            this.isValidSelectedOption(option)
          )
        : -1;
    },
  ...
  computed: {
    ...
    label() {
      ...
      if (this.modelValue && this.modelValue.length) {
        if (
          ObjectUtils.isNotEmpty(this.maxSelectedLabels) &&
    ...
    chipSelectedItems() {
      return ObjectUtils.isNotEmpty(this.maxSelectedLabels) &&
        this.modelValue &&
        this.modelValue.length > this.maxSelectedLabels
