                        ...
                        <VirtualScroller :ref="virtualScrollerRef" v-bind="virtualScrollerOptions" :items="visibleOptions" :style="{ height: scrollHeight }" :tabindex="-1" :disabled="virtualScrollerDisabled">
                            <template v-slot:content="{ styleClass, contentRef, items, getItemOptions, contentStyle, itemSize }">
                                <ul :ref="(el) => listRef(el, contentRef)" :id="id + '_list'" :class="['p-multiselect-items p-component', styleClass]" :style="contentStyle" role="listbox" aria-multiselectable="true">
                                    <draggable :list="options"  @end="updateModel(event,options2)">
                                    <template #item="{ element }" v-for="(option, i) of items" :key="getOptionRenderKey(option, getOptionIndex(i, getItemOptions))">
                                        ...
                                        <li
                                            ...
                                            :class="['p-multiselect-item', { 'p-highlight': isSelected(element), 'p-focus': focusedOptionIndex === getOptionIndex(i, getItemOptions), 'p-disabled': isOptionDisabled(element) }]"
                                            role="option"
                                            ...
                                            @click="onOptionSelect($event, element, getOptionIndex(i, getItemOptions), true)"
                                            @mousemove="onOptionMouseMove($event, getOptionIndex(i, getItemOptions))"
                                        >
                                            <div class="p-checkbox p-component">
                                                <div :class="['p-checkbox-box', { 'p-highlight': isSelected(element) }]">
                                                    <span :class="['p-checkbox-icon', { [checkboxIcon]: isSelected(element) }]"></span>
                                                </div>
                                            </div>
